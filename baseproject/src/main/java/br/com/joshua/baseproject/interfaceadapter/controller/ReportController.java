...
import br.com.joshua.baseproject.interfaceadapter.PersonGatewayReport;
...
public class ReportController {
	...
	@Autowired
	private PersonGatewayReport personGatewayReport;
	...
	public ResponseEntity<byte[]> generatePersonReportPdf(@PathVariable String nameReport) {
		...
		byte[] relatorio = personGatewayReport.generateReportPdf(nameReport);
	...
	public ResponseEntity<byte[]> generatePersonReportCsv() {
		...
		byte[] arquivo = personGatewayReport.generatePersonReportCsv();
